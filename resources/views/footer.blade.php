 <div id="footer" class="color-div">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-2">
                    <div class="widget">
                        <h4 class="widget-title">Ăn vặt online</h4>
                        <div>
                            <ul>
                                ...
                                <li><a href="blog_fullwidth_2col.html"><i class="fa fa-chevron-right"></i> Liên hệ</a></li>
                    ...
                    <div class="widget">
                        ...
                        <div>
                            <div class="contact-info">
                                ...
                                <p>180 Cao lỗ Phone: 01254547437</p>
                                <p> Gửi maiil khi cần thiết: thonglam1176@gmail.com </p>
                            </div>
                        </div>
                    </div>
                  </div>
