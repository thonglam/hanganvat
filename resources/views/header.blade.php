            ...
            <div class="container">
                <div class="pull-left auto-width-left">
                    <ul class="top-menu menu-beta l-inline">
                        <li><a href=""><i class="fa fa-home"></i> 24/8 Nguyễn Văn ĐỪNG, Phường 6, Quận 5</a></li>
                        <li><a href=""><i class="fa fa-phone"></i> 01254547437</a></li>
                    </ul>
                </div>
            ...
            <div class="container">
                ...
                <nav class="main-menu">
                    <ul class="l-inline ov">
                        <li><a href="index.html">Dạng Đồ Ăn</a></li>
                        <li><a href="#">Đồ Ăn </a>
                            <ul class="sub-menu">

                               
                                {{-- @foreach($loai_monan as $loai)
